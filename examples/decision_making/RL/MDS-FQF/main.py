...
# from discrete import SpikeFullQuantileFunction

from policy import FQFPolicy

def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--task', type=str, default='StarGunnerNoFrameskip-v4')
...
def main(args=get_args()):
    ...
    feature_net = SpikingDQN(
        *args.state_shape, action_shape=args.action_shape, device=args.device, time_window = args.time_window, features_only = True
    )
